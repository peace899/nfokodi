...
mbfile=/mnt/storage/Music/webinfo/mb/${artist}.xml
mbalbumfile=/mnt/storage/Music/webinfo/mb/${artist}-${album}.xml
lastfile=/mnt/storage/Music/webinfo/lastfm/${artist}.xml
albumfile=/mnt/storage/Music/webinfo/lastfm/${artist}-${album}.xml
...
artist_l=`echo "$artist" | awk '{$1=$1}1' OFS="+"`
...
album_l=`echo "$album" | awk '{$1=$1}1' OFS="+"`
...
#nfo_tracks=`cat album.nfo |grep -F "<track>" | wc -l`
al_folder=`echo $line`
